...
svgMob.append("text").attr("class","title").attr("x",widthMob/2).attr("y",-8).text("Sydney Mobility change");

Promise.all([d3.csv("sydney/all_sydney.csv"), d3.csv("sydney/sydney_lockdown_level.csv")]).then(function (data) {
